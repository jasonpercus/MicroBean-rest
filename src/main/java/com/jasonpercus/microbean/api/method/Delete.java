...
/**
 * Marque une méthode de controller comme gestionnaire d'une requête HTTP {@code DELETE}.
 *
 ...
 *
 *     @Delete("/{id}")
 *     public boolean delete(@Path("id") long id) {
 *         return true;
 *     }
 * }
 * }</pre>
...
public @interface Delete {
    ...
    /**
     * Définit le chemin relatif associé à la route HTTP {@code DELETE}.
     *
