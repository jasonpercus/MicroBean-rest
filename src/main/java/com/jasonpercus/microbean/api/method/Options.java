...
/**
 * Marque une méthode de controller comme gestionnaire d'une requête HTTP {@code OPTIONS}.
 *
 ...
 *
 *     @Options("/{id}")
 *     public Object optionsById(@Path("id") long id) {
 *         return null;
 *     }
 * }
 * }</pre>
...
public @interface Options {
    ...
    /**
     * Définit le chemin relatif associé à la route HTTP {@code OPTIONS}.
     *
