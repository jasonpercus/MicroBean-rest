...
/**
 * Marque une méthode de controller comme gestionnaire d'une requête HTTP {@code PATCH}.
 *
 ...
 *
 *     @Patch("/{id}")
 *     public User partialUpdate(@Path("id") long id, @Body User patch) {
 *         return patch;
 *     }
 * }
 * }</pre>
...
public @interface Patch {
    ...
    /**
     * Définit le chemin relatif associé à la route HTTP {@code PATCH}.
     *
